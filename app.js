...
async function gerarAvaliacao(){
  ...
  const texto=await callClaude(contexto(hist),[{role:"user",content:"Considere apenas semanas COMPLETAS (ignore a semana em curso). Comente o sleep score e o body battery da ultima semana completa. Liste e comente UMA POR UMA todas as atividades dessa semana (pela data e nome), nao apenas as mais relevantes. Faca a AVALIACAO seguindo as secoes, incluindo a secao Evolucao do perfil com FC de repouso, VO2max, FTP e FC max atuais e como mudaram desde a ultima avaliacao. De continuidade aos seus conselhos anteriores (verificando o que foi seguido)."}],2600);
